...
holding the encrypted, slot-wise logistic function `1 / (1 + exp(-x))`
of `ct`, approximated by a Chebyshev polynomial of the given `degree` on
the interval `[a, b]`. Accuracy degrades outside that interval, and the
